                        ...
                        <div className={styles.imageContainer}>
                            {activeScene.generatedImage ? (
                                <img
                                    ...
                                    alt={`Crime scene: ${activeScene.title} - Generated by Gemini 3 (gemini-3-image-latest)`}
                                    className={styles.sceneImage}
                                />
                            ) : (
                                <div className={styles.placeholder}>
                                    <p>Click &quot;Generate Realistic Scene&quot; to create a Gemini 3 crime scene image</p>
                                    {generationError && (
                            ...
                            {/* Gemini Badge - only shown when real image is generated */}
                            {activeScene.generatedImage && (
